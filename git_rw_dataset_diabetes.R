...
dir_local_dataset = '/mnt/data/Git-RW'
dir_fullpath_file = file.path(dir_local_dataset, "diabetes.csv")
...
saveRDS(model, file.path(dir_local_dataset, "model.rds"))
write.csv(df_diabetes_mean_features, file.path(dir_local_dataset, "diabetes_mean.csv"), row.names=FALSE)
